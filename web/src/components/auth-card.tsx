...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 18 18" className="h-4 w-4" aria-hidden="true">
      <path fill="#EA4335" d="M9 7.364v3.49h4.844c-.213 1.121-.852 2.07-1.81 2.709l2.927 2.273c1.705-1.571 2.689-3.883 2.689-6.636 0-.639-.057-1.253-.164-1.836H9Z" />
      <path fill="#4285F4" d="M9 18c2.43 0 4.469-.803 5.958-2.164l-2.927-2.273c-.803.54-1.831.86-3.031.86-2.33 0-4.304-1.573-5.01-3.687H.965v2.346A9 9 0 0 0 9 18Z" />
      <path fill="#FBBC05" d="M3.99 10.736A5.41 5.41 0 0 1 3.71 9c0-.603.106-1.188.28-1.736V4.918H.965A9 9 0 0 0 0 9c0 1.446.344 2.816.965 4.082l3.025-2.346Z" />
      <path fill="#34A853" d="M9 3.577c1.32 0 2.5.454 3.433 1.344l2.576-2.576C13.465.908 11.427 0 9 0A9 9 0 0 0 .965 4.918L3.99 7.264C4.696 5.15 6.67 3.577 9 3.577Z" />
    </svg>
  );
}
